...
.service("PortfolioGridColumnDefs", function() {
    this.assetColDef = [
        ...
        { name: "Location", field: "location", width: "11%"},
        ...
        { name: "Unit Cost", field: "unitCost", type: "number", width: "11%", cellFilter: "GridUnitCostFilter:row.entity"},
        { name: "Amount", field: "amount", type: "number", width: "15%", enableCellEdit: false, cellFilter: "currency" },
